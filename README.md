...
- `intrinsic_dimensionality_twonn` ranking using the TwoNN intrinsic-dimensionality estimator and PCA reduction to `int(d)`.
...
python scripts/01_rank_samples.py --method intrinsic_dimensionality_twonn
python scripts/02_build_subsets.py --method intrinsic_dimensionality_twonn
python scripts/03_train_resnet18_grid.py --method intrinsic_dimensionality_twonn
