...
def test_aggregation_mean_std(tmp_path: Path) -> None:
    ...
    payloads = [
        {"method": "error_rate_ensemble", "percent_removed": 0, "seed": 101, "best_val_acc": 0.90, "best_val_loss": 0.3, "test_acc": 0.89},
        {"method": "error_rate_ensemble", "percent_removed": 0, "seed": 202, "best_val_acc": 0.92, "best_val_loss": 0.25, "test_acc": 0.91},
        {"method": "error_rate_ensemble", "percent_removed": 5, "seed": 101, "best_val_acc": 0.88, "best_val_loss": 0.33, "test_acc": 0.87},
    ]
    ...
    row = summary_df[
        (summary_df["method"] == "error_rate_ensemble") & (summary_df["percent_removed"] == 0)
    ].iloc[0]
